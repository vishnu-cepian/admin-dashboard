...
const vendorOrdersPage = ({ params}) => {
  ...
  useEffect(() => {
    const params = {
      ...
      sort,
      selectedVendorId: resolvedParams.id,
      ...filters,
    };
    fetchOrders(params);
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="text-2xl font-bold"></h1>
        <Button type="primary" onClick={() => router.push(`/admin/vendors/${resolvedParams.id}`)}>Back to Details</Button>
    </div>
